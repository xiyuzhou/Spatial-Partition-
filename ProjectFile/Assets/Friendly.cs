...
namespace SpatialPartitionPattern
{
    ...
    public class Friendly : Soldier
    {
        ...
        public override void Move(Soldier closestEnemy, int a)
        {
            
            //Rotate towards the closest enemy
            soldierTrans.rotation = Quaternion.LookRotation(a*(closestEnemy.soldierTrans.position - soldierTrans.position));
